...
<h1 className="h3 mb-3 fw-normal text-center" style={{color:'black'}}>Please Signup</h1>
...
<div className="form-floating py-3">
  ...
  <div className="py-2" style={{color:'red'}}>{errors.first?.message}</div>
</div>
<div className="form-floating py-3">
  <input type="email"
  ...
  <div className="py-2" style={{color:'red'}}> {errors.lastname?.message}</div>
</div>
</div>
...
<div className="form-floating py-3">
  ...
  <div className="py-2" style={{color:'red'}}>{errors.email?.message}</div>
</div>
...
<div className="form-floating py-3">
  ...
  <div className="py-2" style={{color:'red'}}> {errors.phone?.message}</div>
</div>
<div className="form-floating py-3">
  <input type="text"
  ...
  <div className="py-2" style={{color:'red'}}>{errors.address?.message}</div>
</div>
</div>
...
<div className="form-floating py-3">
  ...
  <div className="py-2" style={{color:'red'}}>{errors.password?.message}</div>
</div>
...
<div className="py-4 text-center " style={{fontSize:"0.9em",cursor:'pointer'}} onClick={()=>{navigate('/login')}}> Already click here to login</div>
